    ...
    for template in compiled_templates:
        ...
        for compiled_block in compiler.get("final_prompt_blocks") or []:
            ...
            child_rows.append({
                ...
                "set_role": str(compiled_block.get("set_role") or block_meta.get("block_narrative_function") or ""),
                "continuation_from_previous_set": bool(compiled_block.get("continuation_from_previous_set")),
                ...
                "safe_max_words": str(compiled_block.get("safe_max_words") or ""),
                "dialogue_budget_status": str(compiled_block.get("dialogue_budget_status") or ""),
